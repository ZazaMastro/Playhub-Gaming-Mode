...
const strings = {
  ...
  it: {
    mode: "Modalita",
    switchGaming: "Passa alla modalita Gaming",
    switchDesktop: "Passa alla modalita Desktop",
    defaultStartup: "Avvio predefinito",
    desktopMode: "Modalita Desktop",
    gamingMode: "Modalita Gaming",
  ...
  es: {
    ...
    agentReturned: "El agente devolvio",
  },
  fr: {
    mode: "Mode",
    switchGaming: "Passer en mode Gaming",
    switchDesktop: "Passer en mode Bureau",
    defaultStartup: "Demarrage par defaut",
    desktopMode: "Mode Bureau",
    gamingMode: "Mode Gaming",
    notConnected: "Agent non connecte",
    agentReturned: "Agent a renvoye",
  },
  de: {
    mode: "Modus",
  ...
  pt: {
    ...
    gamingMode: "Modo Gaming",
    notConnected: "Agente nao ligado",
